  ...
  return (
    <div className="bg-[#F4F6F8] text-[#0A2540] font-sans min-h-screen flex flex-col selection:bg-[#007BFF]/20 selection:text-[#0A2540]">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 pt-32 pb-20 mt-10 w-full">
        <h1 className="text-4xl md:text-6xl font-heading font-extrabold mb-4 tracking-tight">Terms & Conditions</h1>
        ...
        <div className="space-y-12 text-lg text-[#0A2540]/80 leading-relaxed font-medium">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-extrabold text-[#0A2540] font-heading tracking-normal">1. Acceptance of Terms</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-extrabold text-[#0A2540] font-heading tracking-normal">2. Intellectual Property</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-extrabold text-[#0A2540] font-heading tracking-normal">3. User Conduct</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-extrabold text-[#0A2540] font-heading tracking-normal">4. Limitation of Liability</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-extrabold text-[#0A2540] font-heading tracking-normal">5. Changes to Terms</h2>
            <p>
