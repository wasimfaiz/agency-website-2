...
const services = [
  ...
  },
  {
    ...
    detail: "We combine SEO, performance marketing, and compelling content to build brand awareness and drive conversions. Our strategies are laser-focused on maximizing your ROI and automating your growth engine.",
    meta: ["SEO & Content Strategy", "Performance Marketing", "Conversion Opt."],
    outcomes: [
      "Increased organic and paid traffic",
      "Higher overall conversion rates",
      "Scalable lead generation pipelines",
    ],
    deliverables: [
